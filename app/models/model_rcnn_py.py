...
#    else:
# this lstm layer incompatible with global max pooling, 'pooling' parameter will be ignored
    ...
    l_rnn1 = LSTM(ModelParams['lstm_units'])(l_pool1)
    preds = Dense(y_val.shape[1], activation='softmax')(l_rnn1)
    ...
    try:
        model.fit(x_train, y_train, validation_data=(x_val, y_val),
                  ...
                  callbacks = [keras.callbacks.EarlyStopping(monitor='val_loss', min_delta=0.002, patience=1, verbose=1, 
                                                             mode='auto')])
    except Exception as exc:
        print(exc)
